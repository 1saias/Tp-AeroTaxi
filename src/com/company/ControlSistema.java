...
///TRAMO 2
    ...
    public static LocalDateTime seleccionFecha(List<Vuelos> iniVue){
        Scanner sc = new Scanner(System.in);
        int mes=0,dia=0,hora=0,minuto=0; char resp;
    ...
    public static void mostrarAvionesDisponibles(List<Aviones> flota) {
